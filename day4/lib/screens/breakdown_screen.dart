...
/// lavender background, matching the day4 mockup.
...
class _NutrientRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final ink = muted ? AppColors.muted : AppColors.ink;
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              name,
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: ink),
            ),
          ),
          Text(
            value,
