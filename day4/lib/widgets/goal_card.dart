    ...
    return RichText(
      text: TextSpan(
        children: [
          TextSpan(
            text: '460',
            style: AppText.statValue.copyWith(fontSize: 26, fontWeight: FontWeight.bold),
          ),
          TextSpan(
            text: '/1600',
            style: AppText.statValue.copyWith(fontSize: 20, color: Colors.grey),
          ),
        ],
      ),
    );
...
class MacroCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Text(grams, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
          ...
          SizedBox(
            ...
            child: Stack(
              ...
              children: [
                ...
                Icon(icon, size: 14, color: arcColor),
              ],
            ),
          ),
        ],
