...
import 'package:day5/screens/breakdown_screen.dart';
...
void main() {
  testWidgets('capture screenshot.png', (tester) async {
    ...
    // Open the Daily Breakdown screen so the capture shows day5's work.
    // The pie-chart nav icon is a custom PNG asset since the icon pass.
