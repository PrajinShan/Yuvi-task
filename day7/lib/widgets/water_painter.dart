...
class _WaterCardPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    wavePath.cubicTo(
      ...
      waterY +2.5,
      center.dx + innerRadius -0.8,
      waterY -9,
    );

    // Complete liquid block path
    wavePath.lineTo(center.dx + innerRadius+40, center.dy + innerRadius +20);
    wavePath.lineTo(center.dx - innerRadius+20, center.dy + innerRadius +20);
    wavePath.close();
